...
\title{ Using News' Title and Content Text Features to Detect Fake News: a Viability Analysis}
...
and content from news article for the detection of Fake News using a large dataset and comparing
...
Test \cite{IEEEhowto:IEEEtranpage}
